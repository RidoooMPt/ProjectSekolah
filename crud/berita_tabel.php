...
<body>
    <header>
        <ul class="navlist">
            ...
            <li><a href="berita_tabel.php" class="active">Ekstrakurikuler</a></li>
            <li><a href="guru_tabel.php">Guru</a></li>
            <li><a href="KritikSaran_tabel.php">Kritik & Saran</a></li>
            <li><a href="berita_tabel.php">Berita</a></li>
            <li><a href="../beranda.php">Log Out</a></li>
        </ul>
        <div class="bx bx-menu" id="menu-icon"></div>
    </header>

    <center><h1>Tabel Berita</h1></center>
    <a href="berita_add.php" class="btn-tambah">Tambah Berita</a>
    ...
    <table class="table">
        ...
        $nomor = 1;
        include '../koneksi.php';
        $query_mysqli = mysqli_query($mysqli, "SELECT * FROM berita") or die(mysqli_error());
        ...
        ?>
            <tr>
                ...
                <td><img src="<?php echo $data['foto']; ?>" alt="Foto Berita"></td>
                <td>
                    <a href='berita_edit.php?id=<?php echo $data['id'];?>'>Edit</a>
                    <a href='berita_delete.php?id=<?php echo $data['id'];?>'>Delete</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
