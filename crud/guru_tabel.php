...
<body>
    <header>
        <ul class="navlist">
            ...
            <li><a href="ekskul_tabel.php">Ekstrakurikuler</a></li>
            <li><a href="guru_tabel.php" class="active">Guru</a></li>
    ...
    <center><h1>Tabel guru</h1></center>
    <a href="guru_add.php" class="btn-tambah">Tambah guru</a>
    ...
    <table class="table">
        ...
        $nomor = 1;
        include '../koneksi.php';
        $query_mysqli = mysqli_query($mysqli, "SELECT * FROM guru") or die(mysqli_error());
        ...
        ?>
            <tr>
                ...
                <td><img src="<?php echo $data['foto']; ?>" alt="Foto Guru"></td>
                <td>
                    <a href='guru_edit.php?id=<?php echo $data['id'];?>'>Edit</a>
                    <a href='guru_delete.php?id=<?php echo $data['id'];?>'>Delete</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
