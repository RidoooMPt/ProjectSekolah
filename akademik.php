            ...
            <div class="content-wrapper">
                ...
                <div class="activities-grid">
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="Futsal">
                        <h4>Futsal</h4>
                    </div>
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="Paskib">
                        <h4>Paskib</h4>
                    </div>
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="Paskibra">
                        <h4>Paskibra</h4>
                    </div>
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="Voli">
                        <h4>Voli</h4>
                    </div>
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="Tari">
                        <h4>Tari</h4>
                    </div>
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="PMR">
                        <h4>PMR</h4>
                    </div>
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="Jurnalistik">
                        <h4>Jurnalistik</h4>
                    </div>
                    <div class="activity-card">
                        <img src="/api/placeholder/200/150" alt="DKM">
                        <h4>DKM</h4>
                    </div>
                </div>
            </div>
